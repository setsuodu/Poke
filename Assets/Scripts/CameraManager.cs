...
public class CameraManager : MonoBehaviour
{
    ...
    float maxVert = 90; // define the max vertical angle (to each side)
    float maxHor = 90; // define the max horizontal angle (to each side) 
...
//            transform.localRotation = quatMap * rotFix;
            ...
            var angV = gyro.attitude.eulerAngles.x * maxVert;
            var angH = gyro.attitude.eulerAngles.z * maxHor;
